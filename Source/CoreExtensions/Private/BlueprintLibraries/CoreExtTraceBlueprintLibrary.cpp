...
void UCoreExtTraceBlueprintLibrary::DrawDebugSweptSphere( const UWorld * world, FVector const & start, FVector const & end, const float radius, FColor const & color, const bool use_persistent_lines, const float life_time, const uint8 depth_priority )
{
...
void UCoreExtTraceBlueprintLibrary::DrawDebugSweptBox( const UWorld * world, FVector const & start, FVector const & end, FRotator const & orientation, FVector const & half_size, FColor const & color, const bool use_persistent_lines, const float life_time, const uint8 depth_priority )
{
    auto const trace_vec = end - start;
...
void UCoreExtTraceBlueprintLibrary::DrawDebugLineTraceSingle( const UWorld * World, const FVector & Start, const FVector & End, const EDrawDebugTrace::Type DrawDebugType, const bool bHit, const FHitResult & OutHit, const FLinearColor TraceColor, const FLinearColor TraceHitColor, const float DrawTime )
{
...
void UCoreExtTraceBlueprintLibrary::DrawDebugLineTraceMulti( const UWorld * World, const FVector & Start, const FVector & End, const EDrawDebugTrace::Type DrawDebugType, const bool bHit, const TArray< FHitResult > & OutHits, const FLinearColor TraceColor, const FLinearColor TraceHitColor, const float DrawTime )
{
    if ( DrawDebugType != EDrawDebugTrace::None )
    {
        const auto is_persistent = DrawDebugType == EDrawDebugTrace::Persistent;
...
void UCoreExtTraceBlueprintLibrary::DrawDebugSphereTraceSingle( const UWorld * World, const FVector & Start, const FVector & End, const float Radius, const EDrawDebugTrace::Type DrawDebugType, const bool bHit, const FHitResult & OutHit, const FLinearColor TraceColor, const FLinearColor TraceHitColor, const float DrawTime )
{
    if ( DrawDebugType != EDrawDebugTrace::None )
    {
        const auto is_persistent = DrawDebugType == EDrawDebugTrace::Persistent;
...
void UCoreExtTraceBlueprintLibrary::DrawDebugSphereTraceMulti( const UWorld * world, const FVector & start, const FVector & end, const float radius, const EDrawDebugTrace::Type draw_debug_type, const bool was_hit, const TArray< FHitResult > & hit_results, const FLinearColor trace_color, const FLinearColor trace_hit_color, const float draw_time )
{
...
void UCoreExtTraceBlueprintLibrary::DrawDebugCapsuleTraceSingle( const UWorld * World, const FVector & Start, const FVector & End, const float Radius, const float HalfHeight, const EDrawDebugTrace::Type DrawDebugType, const bool bHit, const FHitResult & OutHit, const FLinearColor TraceColor, const FLinearColor TraceHitColor, const float DrawTime )
{
    if ( DrawDebugType != EDrawDebugTrace::None )
    {
        const auto is_persistent = DrawDebugType == EDrawDebugTrace::Persistent;
...
void UCoreExtTraceBlueprintLibrary::DrawDebugCapsuleTraceMulti( const UWorld * World, const FVector & Start, const FVector & End, const float Radius, const float HalfHeight, const EDrawDebugTrace::Type DrawDebugType, const bool bHit, const TArray< FHitResult > & OutHits, const FLinearColor TraceColor, const FLinearColor TraceHitColor, const float DrawTime )
{
    if ( DrawDebugType != EDrawDebugTrace::None )
    {
        const auto is_persistent = DrawDebugType == EDrawDebugTrace::Persistent;
